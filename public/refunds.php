...
<h2>Digital purchases</h2><p>Because digital downloads are supplied immediately after a successful payment, you request that delivery begins at checkout and acknowledge that the usual cancellation right may end once the download is made available.</p><h2>When to contact us</h2><p>Contact us promptly if a file is corrupt, materially different from its description, or you were charged incorrectly. We will investigate and, where appropriate, replace the file or arrange a refund through the original payment method.</p><p>Refunds for suspected fraud, duplicate payment or technical failure are reviewed individually. Once any track in an order has been downloaded, a refund is not normally available because we cannot confirm that the downloaded file has been removed from the customer’s devices.</p>
</section>
<?php layout_footer();
