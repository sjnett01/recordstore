...
try{
    ...
    if($d['currency']!==$pc['currency']||$d['value']!==paypal_money_value((int)$order['total_pence']))throw new RuntimeException('PayPal payment amount did not match the '.site_name().' order.');
